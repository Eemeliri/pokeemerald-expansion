...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_2, TRAINER_LILA_AND_ROY_3, TRAINER_LILA_AND_ROY_3, TRAINER_LILA_AND_ROY_3, ROUTE124),
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && TRAINER_BATTLE_PARAM.mode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_MALE:
            music = MUS_BW_ENCOUNTER_YOUNGSTER;
            break;
        case TRAINER_ENCOUNTER_MUSIC_FEMALE:
            music = MUS_BW_ENCOUNTER_LASS;
            break;
