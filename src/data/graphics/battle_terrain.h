...
const u16 gBattleTerrainTiles_Plain[] = INCBIN_U16("graphics/battle_terrain/plain/tiles.4bpp.lz");
const u16 gBattleTerrainTilemap_Plain[] = INCBIN_U16("graphics/battle_terrain/plain/map.bin.lz");
