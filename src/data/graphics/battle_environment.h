...
const u16 gBattleEnvironmentTiles_Plain[] = INCBIN_U16("graphics/battle_environment/plain/tiles.4bpp.lz");
const u16 gBattleEnvironmentTilemap_Plain[] = INCBIN_U16("graphics/battle_environment/plain/map.bin.lz");
