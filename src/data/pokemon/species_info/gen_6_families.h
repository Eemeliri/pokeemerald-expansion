...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_GRASS_PELT, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_MEOWSTIC_F] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_COMPETITIVE, ABILITY_INFILTRATOR, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
        .cryId = CRY_MEOWSTIC,
        .natDexNum = NATIONAL_DEX_MEOWSTIC,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_AROMA_VEIL, ABILITY_REGENERATOR },
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_COMPETITIVE, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_STURDY, ABILITY_MISTY_SURGE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_PICKUP, ABILITY_FRISK, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_XERNEAS_NEUTRAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FAIRY_AURA, ABILITY_NONE, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_YVELTAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DARK_AURA, ABILITY_NONE, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NONE, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_PINK,
