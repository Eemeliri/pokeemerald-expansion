...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_QUILLADIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OVERGROW, ABILITY_SOUNDPROOF, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_ARMOR_TAIL, ABILITY_MAGIC_BOUNCE },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_HUGE_POWER, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_AURORUS, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SLIGGOO, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 30, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_NOT_TIME, TIME_DAY})}),
    },
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_NOIVERN}),
    },
