...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SNIPER, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_HEALER, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_DRY_SKIN, ABILITY_TOXIC_BOOST },
    #else
    ...
    [SPECIES_DIGLETT_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_TANGLING_HAIR, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Diglett"),
        .cryId = CRY_DIGLETT,
        .natDexNum = NATIONAL_DEX_DIGLETT,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_GLUTTONY, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GREEN,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_STURDY, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_TANGLED_FEET, ABILITY_EARLY_BIRD, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_LEVITATE, ABILITY_CURSED_BODY}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_INNER_FOCUS, ABILITY_PSYCHIC_SURGE },
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_BATTLE_ARMOR, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_IRON_FIST, ABILITY_UNSEEN_FIST },
    #else
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_FILTER, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_FOREWARN, ABILITY_ICE_SCALES },
    #else
    ...
    [SPECIES_JYNX] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_DRY_SKIN, ABILITY_ICE_SCALES },
    #else
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_LEAF_GUARD, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_GREEN,
