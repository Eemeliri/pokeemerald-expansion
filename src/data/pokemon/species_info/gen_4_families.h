...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_RECKLESS, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_TECHNICIAN, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
...
#define MOTHIM_SPECIES_INFO                                                 \
    {                                                                       \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),                         \
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_COMPOUND_EYES, ABILITY_TINTED_LENS },  \
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_PICKUP, ABILITY_VOLT_ABSORB },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_INFILTRATOR, ABILITY_BAD_DREAMS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SNIPER, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_UXIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Uxie"),
        .cryId = CRY_UXIE,
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Azelf"),
        .cryId = CRY_AZELF,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SLOW_START, ABILITY_NONE, ABILITY_STALL },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_MAGICIAN },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BAD_DREAMS, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
