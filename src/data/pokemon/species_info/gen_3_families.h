...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_RUN_AWAY, ABILITY_STRONG_JAW, ABILITY_QUICK_FEET },
    #else
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_NONE, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_RED,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_COMPOUND_EYES, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_PLUS, ABILITY_LIGHTNING_ROD, ABILITY_ELECTRIC_SURGE },
    #else
    ...
    [SPECIES_MINUN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_MINUS, ABILITY_VOLT_ABSORB, ABILITY_ELECTRIC_SURGE },
    #else
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_GOOEY, ABILITY_STICKY_HOLD, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_WATER_VEIL, ABILITY_OBLIVIOUS, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FILTER, ABILITY_ANGER_POINT },
    #else
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_HUGE_POWER, ABILITY_CONTRARY },
    #else
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_OVERCOAT, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_CLOUD_NINE, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IMMUNITY, ABILITY_TOXIC_BOOST, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_INFILTRATOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SIMPLE, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_FRISK, ABILITY_IRON_FIST },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_CURSED_BODY, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_WALREIN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_ICE_BODY, ABILITY_REGENERATOR },
    #else
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_OBLIVIOUS },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DROUGHT, ABILITY_NONE, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AIR_LOCK, ABILITY_NONE, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_GREEN,
