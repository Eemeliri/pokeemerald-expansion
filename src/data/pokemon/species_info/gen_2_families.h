...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRISK, ABILITY_KEEN_EYE, ABILITY_HUSTLE },
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_SWARM, ABILITY_RATTLED, ABILITY_HUGE_POWER },
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_EARLY_BIRD, ABILITY_HUGE_POWER },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_WATER_ABSORB, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_BLUE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_INFILTRATOR, ABILITY_SIMPLE },
    #else
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_SAP_SIPPER, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HUSTLE, ABILITY_SKILL_LINK, ABILITY_MOODY },
    #else
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SKILL_LINK, ABILITY_MOODY },
    #else
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SAP_SIPPER, ABILITY_SCRAPPY },
    #else
