static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), 16, 30},
    [HEAL_LOCATION_PLAYERS_HOUSE - 1] = {MAP_GROUP(LEHTI_PLAYERS_HOUSE), MAP_NUM(LEHTI_PLAYERS_HOUSE), 5, 8},
};
