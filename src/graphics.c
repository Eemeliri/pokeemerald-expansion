...
const u16 gBagScreenMale_Pal[] = INCBIN_U16("graphics/bag/bag_screen_male.gbapal");
const u16 gBagScreenFemale_Pal[] = INCBIN_U16("graphics/bag/bag_screen_female.gbapal");
