...
const u16 gTilesetAnims_MauvilleGameCorner_Lights_Frame0[] = INCBIN_U16("data/tilesets/secondary/big_game_corner/anim/lights/light_anim_0.4bpp");
const u16 gTilesetAnims_MauvilleGameCorner_Lights_Frame1[] = INCBIN_U16("data/tilesets/secondary/big_game_corner/anim/lights/light_anim_1.4bpp");
const u16 gTilesetAnims_MauvilleGameCorner_Lights_Frame2[] = INCBIN_U16("data/tilesets/secondary/big_game_corner/anim/lights/light_anim_2.4bpp");
const u16 gTilesetAnims_MauvilleGameCorner_Lights_Frame3[] = INCBIN_U16("data/tilesets/secondary/big_game_corner/anim/lights/light_anim_3.4bpp");
const u16 gTilesetAnims_MauvilleGameCorner_Lights_Frame4[] = INCBIN_U16("data/tilesets/secondary/big_game_corner/anim/lights/light_anim_4.4bpp");
const u16 gTilesetAnims_MauvilleGameCorner_Lights_Frame5[] = INCBIN_U16("data/tilesets/secondary/big_game_corner/anim/lights/light_anim_5.4bpp");
