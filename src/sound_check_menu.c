...
#define SOUND_LIST_BGM \
    ...
    X(MUS_BW_XTRAN_CALL               , "MUS-BW-XTRAN-CALL"                          ) \
    X(MUS_BW_ENCOUNTER_YOUNGSTER      , "MUS-BW-ENCOUNTER-YOUNGSTER"                 ) \
    X(MUS_BW_VS_TRAINER               , "MUS-BW-VS-TRAINER"                          ) \
    X(MUS_BW_VICTORY_TRAINER          , "MUS-BW-VICTORY-TRAINER"                     ) \
    X(MUS_BW_ENCOUNTER_LASS           , "MUS-BW-ENCOUNTER-LASS"                      ) \
    ...
    X(MUS_BW_DREAMYARD_B1F            , "MUS-BW-DREAMYARD-B1F"                       ) \
    ...
    X(MUS_BW_EVOLUTION_NO_INTRO       , "MUS-BW-EVOLUTION-NO-INTRO"                  ) \
    ...
    X(MUS_BW_VS_WINNING               , "MUS-BW-VS-WINNING"                          ) \
    ...
    X(MUS_BW_ENCOUNTER_BACKPACKER     , "MUS-BW-ENCOUNTER-BACKPACKER"                ) \
    X(MUS_BW_NIMBASA                  , "MUS-BW-NIMBASA"                             ) \
    X(MUS_BW_BIANCA                   , "MUS-BW-BIANCA"                              ) \
    X(MUS_BW_EMOTION                  , "MUS-BW-EMOTION"                             ) \
    X(MUS_BW_N                        , "MUS-BW-N"                                   ) \
    X(MUS_BW_VS_N_1                   , "MUS-BW-VS-N-1"                              ) \
    X(MUS_BW_VS_IN_PINCH              , "MUS-BW-VS-IN-PINCH"                         ) \
    X(MUS_BW_CYCLING                  , "MUS-BW-CYCLING"                             ) \
    X(MUS_BW_ALDER                    , "MUS-BW-ALDER"                               ) \
    X(MUS_BW_DRAWBRIDGE               , "MUS-BW-DRAWBRIDGE"                          ) \
    ...
    X(MUS_BW_ENCOUNTER_PARASOL        , "MUS-BW-ENCOUNTER-PARASOL"                   ) \
    X(MUS_BW_ENCOUNTER_SCIENTIST      , "MUS-BW-ENCOUNTER-SCIENTIST"                 ) \
    X(MUS_BW_CHARGESTONE_CAVE         , "MUS-BW-CHARGESTONE-CAVE"                    ) \
    X(MUS_BW_CHARGESTONE_CAVE_B1F     , "MUS-BW-CHARGESTONE-CAVE-B1F"                ) \
    X(MUS_BW_CHARGESTONE_CAVE_B2F     , "MUS-BW-CHARGESTONE-CAVE-B2F"                ) \
    X(MUS_BW_MISTRALTON               , "MUS-BW-MISTRALTON"                          ) \
    X(MUS_BW_JUNIPER_2                , "MUS-BW-JUNIPER-2"                           ) \
    ...
    X(MUS_BW_OBTAIN_STONE             , "MUS-BW-OBTAIN-STONE"                        ) \
    X(MUS_BW_TUBELINE_BRIDGE          , "MUS-BW-TUBELINE-BRIDGE"                     ) \
    X(MUS_BW_POKE_MART                , "MUS-BW-POKE-MART"                           ) \
    ...
    X(MUS_BW_LEGEND_COME              , "MUS-BW-LEGEND-COME"                         ) \
    X(MUS_BW_LEGEND_BORN              , "MUS-BW-LEGEND-BORN"                         ) \
    ...
    X(MUS_BW_MUSICAL_CURTAIN_RAISES   , "MUS-BW-MUSICAL-CURTAIN-RAISES"              ) \
    X(MUS_BW_MUSICAL_STARDOM          , "MUS-BW-MUSICAL-STARDOM"                     ) \
    X(MUS_BW_MUSICAL_FOREST_STROLL    , "MUS-BW-MUSICAL-FOREST-STROLL"               ) \
    X(MUS_BW_MUSICAL_A_SWEET_SOIREE   , "MUS-BW-MUSICAL-A-SWEET-SOIREE"              ) \
    X(MUS_BW_MUSICAL_EXCITING_NIMBASA , "MUS-BW-MUSICAL-EXCITING-NIMBASA"            ) \
    X(MUS_BW_MUSICAL_DLC_MUNNA        , "MUS-BW-MUSICAL-DLC-MUNNA"                   ) \
    X(MUS_BW_MUSICAL_DLC_SMASH        , "MUS-BW-MUSICAL-DLC-SMASH"                   ) \
    X(MUS_BW_MUSICAL_DLC_FESTA        , "MUS-BW-MUSICAL-DLC-FESTA"                   ) \
    X(MUS_BW_MUSICAL_DLC_RELIC        , "MUS-BW-MUSICAL-DLC-RELIC"                   ) \
    X(MUS_BW_MUSICAL_DLC_RUNPA        , "MUS-BW-MUSICAL-DLC-RUNPA"                   ) \
    X(MUS_BW_FERRIS_WHEEL             , "MUS-BW-FERRIS-WHEEL"                        ) \
    X(MUS_BW_FEELING_CHECK            , "MUS-BW-FEELING-CHECK"                       ) \
    X(MUS_BW_FEELING_CHECK_HIGH       , "MUS-BW-FEELING-CHECK-HIGH"                  ) \
    X(MUS_BW_FEELING_CHECK_MEDIUM     , "MUS-BW-FEELING-CHECK-MEDIUM"                ) \
    X(MUS_BW_FEELING_CHECK_LOW        , "MUS-BW-FEELING-CHECK-LOW"                   ) \
    X(MUS_BW_VS_LEGEND                , "MUS-BW-VS-LEGEND"                           ) \
    X(MUS_BW_ANVILLE_TOWN             , "MUS-BW-ANVILLE-TOWN"                        ) \
    ...
    X(MUS_BW_POKETRANSFER_LAB         , "MUS-BW-POKETRANSFER-LAB"                    ) \
    X(MUS_BW_POKETRANSFER_BOX         , "MUS-BW-POKETRANSFER-BOX"                    ) \
    X(MUS_BW_POKETRANSFER_GAME        , "MUS-BW-POKETRANSFER-GAME"                   ) \
    ...
    X(MUS_BW_FUNFEST_START            , "MUS-BW-FUNFEST-START"                       ) \
    X(MUS_BW_ENTRALINK_VISIT          , "MUS-BW-ENTRALINK-VISIT"                     ) \
    X(MUS_BW_FUNFEST_CLEAR            , "MUS-BW-FUNFEST-CLEAR"                       ) \
    X(MUS_BW_FUNFEST_FAILED           , "MUS-BW-FUNFEST-FAILED"                      ) \
    X(MUS_BW_ENCOUNTER_GENTLEMAN      , "MUS-BW-ENCOUNTER-GENTLEMAN"                 ) \
    X(MUS_BW_UNDELLA_SPRING           , "MUS-BW-UNDELLA-SPRING"                      ) \
    X(MUS_BW_UNDELLA_SUMMER           , "MUS-BW-UNDELLA-SUMMER"                      ) \
    X(MUS_BW_CYNTHIA                  , "MUS-BW-CYNTHIA"                             ) \
